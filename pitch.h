...
static inline void pitch_init(struct pitch_t *p, double dt)
{
    p->dt = dt;
    p->x = 0.0;
    p->v = 0.0;
...
static inline void pitch_dt_observation(struct pitch_t *p, double dx)
{
...
static inline double pitch_current(struct pitch_t *p)
{
    return p->v;
}
